...
#include "PaintGame_JohnsonCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class APaintGame_JohnsonCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class APaintGame_JohnsonProjectile> ProjectileClass;
