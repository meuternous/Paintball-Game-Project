...
// Sets default values
AFogActor::AFogActor()
	:m_wholeTextureRegion(0, 0, 0, 0, m_textureSize, m_textureSize) {
	...
	{
		static ConstructorHelpers::FObjectFinder <UMaterial> asset(TEXT("Material'/Game/FirstPerson/Shader/FogMat.FogMat'"));
